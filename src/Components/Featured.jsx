...
const Featured = () => {
    return (
        <div>
            ...
            ></SectionTitle>
            <div className="py-5 px-2 grid grid-cols-1 md:grid-cols-3 gap-4 bg-base-200">
                    ...
                    <div className="card bg-base-100 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button className="btn btn-secondary"><a href="https://glittering-dragon-4a6433.netlify.app/">Click to Visit</a></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card bg-base-100 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button className="btn btn-secondary"><a href="https://heroic-semolina-7b2e02.netlify.app/">Click to Visit</a></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card bg-base-100 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button className="btn btn-secondary"><a href="https://the-morning-posts.surge.sh/">Click to Visit</a></button>
                            </div>
                        </div>
                    </div>
