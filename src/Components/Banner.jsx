            ...
            <div className="my-[100px] flex items-center flex-col lg:flex-row-reverse">
               ...
               <img src={myPic} className="w-[300px] h-[300px] p-1 rounded-full border bg-[#ede8ad]" />
                ...
                <div className='w-1/2 text-center '>
                    ...
                    <p className="py-6 text-3xl font-bold text-[#b895cf]">A front end focused MERN stack web developer.</p>
                    <button className="btn text-white bg-alpha"><a href='md-rafiul-islam-resume.pdf' download>Download my Resume</a></button>
                </div>
            </div>
        </div>
    );
